...
$GDXIN Data_IsoflavoneExtraction_v6_9-1-2020_addingstage4.gdx
...
Sets
         ...
         kP(k)           pre processing componenets/largesoy,soy,impurity/
...
Tcw_in_TE,Tcw_out_TE,moist_soy_TE,P_agit_TE,Po_impeller_TE,D_soymeal,Delta_t_TE, Eff_TE,
*parameters for the Maceration (MC)
moist_soy_MC,Delta_t_MC, Eff_MC,
...
Equations
Initial_mass(kP)  flow assignment
...
Initial_mass(kP)..  M('1',kP) =e= Qf*Frac(kP);
...
Extract_Eff_TE          Extraction efficincy of glucoside
...
Extract_Eff_TE..    M('6','i-glucoside')=e= sum(kSld,M('4',kSld))*Frac('i-glucoside')*Eff_TE;
...
Equations
*Tank Design
Extract_Eff_MC      Extraction efficincy of glucoside
...
Extract_Eff_MC..        M('9','i-glucoside')=e= sum(kSld,M('7',kSld))*Frac('i-glucoside')*Eff_MC;
...
*Glucoside_Conversion          Glucoside left over after hydrolysis
...
*Glucoside_Conversion..  M('25', 'i-glucoside') =e= M('23', 'i-glucoside')-M('25','i-aglycone');
...
*You do have consumable cost in stage 2 with filtration. Membrane consumable cost!! Be sure to edit this.
